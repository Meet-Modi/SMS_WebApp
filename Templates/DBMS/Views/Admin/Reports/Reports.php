...
<body class="animsition">
	...
	<header class="header1">
		...
		<div class="row">
			...
			<form action="Reports.php">
					<div class='w-size2 p-t-20'>
						<button class='flex-c-m size2 bg4 bo-rad-23 hov1 m-text3 trans-0-4' name="ShowNewReports" value="ShowNewReports">
							Show New Reports.
						</button>
					</div>
				</form><span style="display:inline-block; width: 300px;"></span>
			<div class="block4 wrap-pic-w">
				<form action="Reports.php">
					<div class='w-size2 p-t-20'>
						<button class='flex-c-m size2 bg4 bo-rad-23 hov1 m-text3 trans-0-4' name="SearchReport" value="SearchReport">
							Search Reports.
						</button>
					</div>
				</form>
		...
		<?php 
			...
			if(isset($_GET['ShowNewReports'])){
					$sql = "SELECT * FROM report WHERE Report_Date = CURRENT_DATE";
					$result = mysqli_query($conn,$sql);
					echo "<br><center><p class='meet-head'>Today's New Reports</p><br>";
					if ($result->num_rows > 0) 
					{    
						echo "<align:'center'>";
						...
						{ 
							echo "<tr><th>".$row["Remarks"]."</th>
								  ...
								  <th><a href='".$row["ReportPDF"]."' target='_blank'>Download Report</a>
								  </tr>";
						}
								  echo "</table></align>";
					} else 
			...
			if(isset($_GET['SearchReport'])){
				...
				<form action='Reports.php?ReportsSearched=1'>
			...
			if(isset($_GET['ReportSearched'])){
					...
					$did = $_GET['did'];
					if($pid > 0){
						$sql = "CALL SearchReportPatient('$pid')";
					}
					else if($did > 0){
						$sql = "CALL Display_Reports_Doctor('$did')";
					}
