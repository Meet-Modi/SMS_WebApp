	...
	<header class="header1">
		...
		<?php 
			...
			<form action='Patients.php'>
					...
					<div class='effect1 w-size9'>
						Patient Age :
						<input class='s-text7 bg6 w-full p-b-5' type='text' name='Age'>		
					</div>
					<br>
					...
					<div class='effect1 w-size9'>
						Admit Date :
						<input class='s-text7 bg6 w-full p-b-5' type='date' name='AdmitDate'>		
					</div>
					<br>
					<div class='w-size2 p-t-20'>
						<!-- Button -->
			...
			if(isset($_GET['SearchPatient'])){
				...
				<form action='Patients.php?PatientSearched=1'>
					<div class='effect1 w-size9'>
						Patient Name :
						<input class='s-text7 bg6 w-full p-b-5' type='text' name='Name'>		
					</div>
			...
			if(isset($_GET['PatientAdded'])){
				...
				echo("Type ".$Type);
				echo("<br>");				
				$sql = "INSERT INTO patient(Patient_type, Patient_Name, Gender, Admit_From_Date, Patient_ID, Age) VALUES ('$Type','$Name','$Gender','$AdmitDate', '$PatientID','$Age')";
				echo $sql;
