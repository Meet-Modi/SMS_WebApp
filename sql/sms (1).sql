...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2020 at 02:09 PM
...
--
ALTER TABLE `amc`
  MODIFY `amcid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `complaint`
  MODIFY `complaintid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `service`
  MODIFY `serviceid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
